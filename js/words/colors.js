...
define(
    ...
    function() {
        ...
        function set_color_scheme(cs) {
            ...
            document.body.style = (
                "background: " + outer_color("background") + ";"
            );
        ...
        function RGB__HSV(rgb) {
            // Converts an RGB array of three numbers on [0, 1] into an
            // array of three HSV numbers. S and V will be on [0, 1], and
            // H will be in radians.
            let r = RGB[0];
            let g = RGB[1];
            let b = RGB[2];
        ...
        function HSV__RGB(hsv) {
            // Returns an RGB array on [0, 1] for the color with the
            // given hue, saturation, and value (given as an array of
            // three numbers). Hue should be in radians, and both s and v
            // should be in [0, 1].
            let h = hsv[0];
            let s = hsv[1];
            let v = hsv[2];
  ...
  */
        ...
        function HEX__RGB(hex) {
            // Converts a HEX string to an RGB triple. RGB values are on
            // [0, 1].
            if (hex[0] == '#') {
                hex = hex.slice(1);
            }
