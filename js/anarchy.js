...
export function scramble_seed(s) {
...
export function rev_prng(x, seed) {
...
export function cohort_outer(cohort, inner, cohort_size) {
...
export function cohort_interleave(inner, cohort_size) {
...
export function rev_cohort_interleave(inner, cohort_size) {
...
export function cohort_fold(inner, cohort_size, seed) {
...
export function cohort_spin(inner, cohort_size, seed) {
    // Applies a circular offset
    return posmod((inner + seed), cohort_size) >>> 0;
}

export function rev_cohort_spin(inner, cohort_size, seed) {
...
export function distribution_spilt_point(
    total,
    n_segments,
    segment_capacity,
    roughness,
...
export function distribution_portion(
    segment,
    total,
    n_segments,
    segment_capacity,
...
export function distribution_prior_sum(
    segment,
    total,
    n_segments,
    segment_capacity,
...
export function distribution_segment(
    index,
    total,
    n_segments,
    segment_capacity,
...
export function max_smaller(value, sumtable) {
